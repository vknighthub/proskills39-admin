...
export { SignOutIcon } from '@/components/icons/sidebar/sign-out-alt';
export { CircleCheckIcon } from '@/components/icons/sidebar/circle-check';
export { HomeIcon } from '@/components/icons/sidebar/home';
export { SaveIcon } from '@/components/icons/sidebar/save';
export { ShieldAltIcon } from '@/components/icons/sidebar/shield-alt';
export { TasksAltIcon } from '@/components/icons/sidebar/tasks-alt';
export { ThumbtackIcon } from '@/components/icons/sidebar/thumbtack';
export { UniversityIcon } from '@/components/icons/sidebar/university';
export { UserCheckIcon } from '@/components/icons/sidebar/user-check';
export { MessageIcon } from '@/components/icons/sidebar/message';
