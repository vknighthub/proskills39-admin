...
const ProductList = ({
  ...
  let columns = [
    ...
    },
    {
      title: (
        <TitleWithSort
          ...
          ascending={
            ...
            sortingObj.column === 'fundName'
          }
          isActive={sortingObj.column === 'fundName'}
        />
      ),
      ...
      width: 300,
      ellipsis: true,
      onHeaderCell: () => onHeaderClick('fundName'),
    },
    {
      title: t('table:table-total-proposal'),
      dataIndex: 'totalChallenge',
      key: 'totalChallenge',
      width: 120,
      align: 'center',
      ellipsis: true,
